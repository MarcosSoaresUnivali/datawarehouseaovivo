...
db = create_engine("postgresql://dpg-cs2tbi3v2p9s738oaq7g-a.oregon-postgres.render.com:5432/mpsmaker_postgresql")
...
class Usuario(Base):
    ...
    def _init_(self, nome, email, senha, ativo=True):
        self.nome = nome
        self.email = email
        self.senha = senha
        self.ativo = ativo
...
class Livro(Base):
    ...
    def _init_(self, titulo, qtde_paginas, dono):
        self.titulo = titulo
